            ...
            <form action="{{ action('Admin\KijiController@update') }}" method="post" enctype="multipart/form-data">
               ...
               <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <img src="{{ asset('storage/image/' . $content_form->image_path) }}">
                            <div style="margin-bottom:2rem;"></div>
                                 <input type="file" class="form-control-file" name="image" value="{{ old('image' , $content_form['image_path']) }}">
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" name="seireki" value="{{ old('seireki' ,$content_form->seireki) }}">
                    </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2" for="body">記事本文</label>
                        <div class="col-md-10">
                            <textarea class="form-control" name="body" rows="15">{{ old('body' ,$content_form->body) }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2" for="googlemap">Googlemap</label>
                        <div class="col-md-10">
                            <textarea class="form-control" name="Googlemap" rows="5">{{ old('Googlemap' ,$content_form->googlemap) }}</textarea>
                        </div>
                    </div>
